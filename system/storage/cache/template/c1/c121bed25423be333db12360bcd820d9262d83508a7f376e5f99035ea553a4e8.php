...
class __TwigTemplate_f07f1dbccbfafb44ff2f328a2e00c1bcb8fd2ebca07269bcd946e5bda5d5106e extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["ishi_sliderimage"]) {
          ...
          <a href=\"";
            ...
            if (twig_get_attribute($this->env, $this->source, $context["ishi_sliderimage"], "title", [], "any", false, false, false, 12)) {
                ...
                echo twig_get_attribute($this->env, $this->source, $context["ishi_sliderimage"], "titlebgcolor", [], "any", false, false, false, 13);
                echo "\">";

...
class __TwigTemplate_3c67f946fdebe565933f47037a9905f8614b994c44b110216ae5fd535b1fc807 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["language"]) {
            // line 339
            echo "\t\thtml  += '<div class=\"input-group\"><span class=\"input-group-addon\"><img src=\"language/";
            echo twig_get_attribute($this->env, $this->source, $context["language"], "code", [], "any", false, false, false, 339);
            echo "/";
            echo twig_get_attribute($this->env, $this->source, $context["language"], "code", [], "any", false, false, false, 339);
            echo ".png\" title=\"";
            echo twig_get_attribute($this->env, $this->source, $context["language"], "name", [], "any", false, false, false, 339);
            echo "\" /></span>';
\t\thtml  += '<input type=\"text\" name=\"ishibanner['+ banner_row +'][subtitle][";
            // line 340
            echo twig_get_attribute($this->env, $this->source, $context["language"], "language_id", [], "any", false, false, false, 340);
            echo "]\" placeholder=\"";
            echo ($context["entry_subtitle"] ?? null);
            echo "\" class=\"form-control\"/>';
\t\thtml  += '</div>'; 
...
\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["language"]) {
            ...
            echo twig_get_attribute($this->env, $this->source, $context["language"], "code", [], "any", false, false, false, 350);
            echo ".png\" title=\"";
            echo twig_get_attribute($this->env, $this->source, $context["language"], "name", [], "any", false, false, false, 350);
            echo "\" /></span>';
\t\thtml  += '<input type=\"text\" name=\"ishibanner['+ banner_row +'][button_name][";
            // line 351
            echo twig_get_attribute($this->env, $this->source, $context["language"], "language_id", [], "any", false, false, false, 351);

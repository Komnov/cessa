...
use Ipol\Ozon\Api\Entity\Request\ReportBinary as ObjRequest;
use Ipol\Ozon\Api\Entity\Response\ReportBinary as ObjResponse;
 ...
 */
class ReportBinary extends GeneralMethod
{
    /**
     * ReportBinary constructor.

...
use Ipol\Ozon\Api\Entity\Request\ManifestRemove as ObjRequest;
use Ipol\Ozon\Api\Entity\Response\ManifestRemove as ObjResponse;
 ...
 */
class ManifestRemove extends GeneralMethod
{
    /**
     * ManifestRemove constructor.

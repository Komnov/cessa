...
use Ipol\Ozon\Api\Entity\Request\DocumentList as ObjRequest;
use Ipol\Ozon\Api\Entity\Response\DocumentList as ObjResponse;
 ...
 */
class DocumentList extends GeneralMethod
{
    /**

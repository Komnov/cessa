...
class ControllerExtensionPaymentDolyame extends Controller
{
	...
	public function install()
	{
		...
		$this->model_user_user_group->addPermission($this->user->getId(), 'access', 'extension/payment/dolyame/transactions');
        $this->model_user_user_group->addPermission($this->user->getId(), 'modify', 'extension/payment/dolyame/transactions' );
	}
